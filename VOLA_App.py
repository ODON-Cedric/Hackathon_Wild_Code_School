...
#Labels
canvas_titre = Canvas(width=123.478, height=10)
label_titre = Label(canvas_titre, text="Track Name", font="Open_Sans 10", anchor=CENTER)
canvas_titre.create_window(123.478/2, 6, window=label_titre, anchor=CENTER)
canvas_titre.place(x=227, y=522.449)

#Labels
canvas_artiste = Canvas(width=123.478, height=10)
label_artiste = Label(canvas_artiste, text="- Artist -", font="Open_Sans 10", anchor=CENTER)
canvas_artiste.create_window(123.478/2, 6, window=label_artiste, anchor=CENTER)
canvas_artiste.place(x=227, y=538)
